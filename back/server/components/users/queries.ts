...
export const QUERY_GET_USER = 'SELECT id,create_time,createdBy,email,lastname,name,organisation,username,address,phonenumber,postalCode,city, picture_url FROM `user` WHERE `id` = ?';
