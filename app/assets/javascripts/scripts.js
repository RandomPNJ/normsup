    ...
    if (0 !== e(this).length) {
      ...
      var n = {
        ...
        autoHide: function() {
          ...
          var o = function(a) {
            a.preventDefault();
            var o = e(this).closest(".m-datatable__row"),
            i = e(o).next();
            if (e(i).hasClass("m-datatable__row-detail")) e(this).find("i").removeClass(n.getOption("layout.icons.rowDetail.expand")).addClass(n.getOption("layout.icons.rowDetail.collapse")), e(i).remove();
            else {
              ...
              s = e("<table/>");
              e(l).each(function() {
                var a = e(this).data("field"),
                o = e.grep(t.columns, function(e, t) {
                  return a === e.field
                })[0];
        ...
        visible: function(a) {
          if (e(n.recentNode.length)) {
            ...
            a ? (n.recentNode === n.nodeCols && delete t.columns[i].responsive, e(n.recentNode).show()) : (n.recentNode === n.nodeCols && n.setOption("columns." + i + ".responsive", {
              hidden: "xl"
    ...
    l = {
      ...
      updateProgress: function() {
        ...
        if (mUtil.hasClass(n, "m-wizard--1")) {
          var e = a.currentStep / a.totalSteps * 100,
  ...
  return {
    ...
    initHeader: function() {
      ...
      a = mUtil.get("m_header"), o = {
        ...
        $("#m_topbar_notification_icon .m-nav__link-icon.notified").addClass("m-animate-shake"), $("#m_topbar_notification_icon .m-nav__link-badge.notified").addClass("m-animate-blink")
      }, 3e3), setInterval(function() {
        $("#m_topbar_notification_icon .m-nav__link-icon.notified").removeClass("m-animate-shake"), $("#m_topbar_notification_icon .m-nav__link-badge.notified").removeClass("m-animate-blink")
    ...
    initAside: function() {
      var n, o;
      n = mUtil.get("m_aside_left"), o = mUtil.hasClass(n, "m-aside-left--offcanvas-default") ? "m-aside-left--offcanvas-default" : "m-aside-left", a = new mOffcanvas("m_aside_left", {
        baseClass: o,
        overlay: !0,
      ...
      function() {
        var e = $("#m_ver_menu"),
        a = "1" === e.data("m-menu-dropdown") ? "dropdown" : "accordion";
