! function(t, e) {
  ...
  return function(t) {
    ...
    function c(t, e, n, r, i) {
      ...
      var o = t[n.field],
      s = e[n.field];
      return null == o && r && (o = r[n.field]), null == s && i && (s = i[n.field]), p(o, s) * (n.order || 1)
    }
    ...
    e.isPrimaryMouseButton = function(t) {
      ...
      if (s = c(t, e, n[o], r, i)) return s;
      return 0
    }, e.compareByFieldSpec = c, e.flexibleCompare = p, e.dayIDs = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"], e.unitsDesc = ["year", "month", "week", "day", "hour", "minute", "second", "millisecond"], e.diffDayTime = function(t, e) {
      return r.duration({
    ...
    }, e.computeGreatestUnit = h, e.computeDurationGreatestUnit = function(t, e) {
      var n = h(t);
    ...
    }, e.hasOwnProp = m, e.applyAll = function(t, e, n) {
    ...
    function p(t, e, n) {
      ...
      return r.isMoment(p) || o.isNativeDate(p) || void 0 === p ? c = r.apply(null, t) : (l = !1, u = !1, h ? s.test(p) ? (t = [p += "-01"], l = !0, u = !0) : (d = a.exec(p)) && (l = !d[5], u = !0) : i.isArray(p) && (u = !0), c = e || l ? r.utc.apply(r, t) : r.apply(null, t), l ? (c._ambigTime = !0, c._ambigZone = !0) : n && (u ? c._ambigZone = !0 : h && c.utcOffset(p))), c._fullCalendar = !0, c
    }
    e.default = c, c.utc = function() {
      var t = p(arguments, !0);
    ...
    e.View = A.default;
    var B = n(22);
    e.defineView = B.defineView, e.getViewConfig = B.getViewConfig;
    var k = n(55);
    ...
    function c(t, n) {
      var i, o;
      i = e.localeOptionHash[t] || (e.localeOptionHash[t] = {}), n && (i = e.localeOptionHash[t] = s.mergeOptions([i, n])), o = p(t), r.each(u, function(t, e) {
        null == i[t] && (i[t] = e(o, i))
    ...
    }, e.locale = c, e.getMomentLocaleData = p, c("en", s.englishDefaults)
  }, function(t, e, n) {
    Object.defineProperty(e, "__esModule", {
      value: !0
    });
    ...
    l = function() {
      ...
      return t.createFromRawProps = function(e, n, a) {
        ...
        return (u = i.default.parse(h, p.source)) && (d = s.default.createFromDiff(e.dateProfile, u, a)), f.id !== p.id && (y = f.id), r.isArraysEqual(f.className, p.className) || (m = f.className), o.default.copyVerbatimStandardProps(f, v), (c = new t).eventDefId = y, c.className = m, c.verbatimStandardProps = v, c.miscProps = g, d && (c.dateMutation = d), c
    ...
    e.formatDate = c, e.formatRange = function(t, e, n, i, o) {
      ...
      function(t, e, n, r, i) {
        ...
        for (a = o; a <= s; a++) g += c[a], m += p[a];
        return (g || m) && (b = i ? m + r + g : g + r + m), y(h + b + f)
    ...
    o = function() {
      ...
      return t.createFromDiff = function(e, n, i) {
        ...
        return o = c(n.start, e.start), n.end && (s = c(n.unzonedRange.getEnd(), e.unzonedRange.getEnd()).subtract(o)), (a = new t).clearEnd = l, a.forceTimed = u, a.forceAllDay = d, a.setDateDelta(o), a.setEndDelta(s), a
    ...
    o = function(t) {
      ...
      return r.__extends(e, t), e.prototype.updateDayTable = function() {
        ...
        d = [];
        for (e = 0; e < this.rowCnt; e++) r = (n = e * s) + s - 1, i = Math.max(l, n), o = Math.min(u, r), (i = Math.ceil(i)) <= (o = Math.floor(o)) && d.push({
          row: e,
        ...
        for (r = (n = e * a) + a - 1, i = n; i <= r; i++) o = Math.max(u, i), s = Math.min(d, i), (o = Math.ceil(o)) <= (s = Math.floor(s)) && c.push({
          row: e,
    ...
    m = function(t) {
      ...
      return r.__extends(e, t), e.prototype.componentFootprintToSegs = function(t) {
        ...
        D = 0,
        E = function(n) {
          for (; D < n;)(l = m.getCellSegs(t, D, e)).length && (c = r[e - 1][D], y = m.renderMoreLink(t, D, l), v = i("<div/>").append(y), c.append(v), w.push(v[0])), D++
        };
        if (e && e < b.segLevels.length) {
          for (n = b.segLevels[e - 1], r = b.cellMatrix, o = b.tbodyEl.children().slice(e).addClass("fc-limited").get(), s = 0; s < n.length; s++) {
            ...
            if (u) {
              for (p = (c = r[e - 1][a.leftCol]).attr("rowspan") || 1, h = [], f = 0; f < d.length; f++) g = i('<td class="fc-more-cell"/>').attr("rowspan", p), l = d[f], y = this.renderMoreLink(t, a.leftCol + f, [a].concat(l)), v = i("<div/>").append(y), g.append(v), h.push(g[0]), w.push(g[0]);
        ...
        c = new l.default(s, a),
        p = [];
        for (n = 0; n < t.length; n++)(o = (r = t[n]).footprint.componentFootprint.unzonedRange.intersect(c)) && p.push(i.extend({}, r, {
    ...
    e.default = d, d.prototype.dateProfileGeneratorClass = l.default, d.prototype.dayGridClass = u.default
  }, , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , , function(t, e, n) {
    Object.defineProperty(e, "__esModule", {
      value: !0
    });
    ...
    l = function(t) {
      ...
      return r.__extends(e, t), e.parse = function(t, e) {
        ...
        u = this.ajaxSettings,
        d = {};
        return null == (r = this.startParam) && (r = l.opt("startParam")), null == (o = this.endParam) && (o = l.opt("endParam")), null == (s = this.timezoneParam) && (s = l.opt("timezoneParam")), a = i.isFunction(u.data) ? u.data() : u.data || {}, i.extend(d, a), d[r] = t.format(), d[o] = e.format(), n && "local" !== n && (d[s] = n), d
      }, e.prototype.getPrimitive = function() {
        return this.url
    ...
    s = function() {
      ...
      return t.prototype.opt = function(t) {
        ...
        return i = this.buildValidRange(), i = this.trimHiddenDays(i), n && (t = this.msToUtcMoment(i.constrainDate(t), p)), a = this.buildCurrentRangeInfo(t, e), l = /^(year|month|week|day)$/.test(a.unit), u = this.buildRenderRange(this.trimHiddenDays(a.unzonedRange), a.unit, l), d = (u = this.trimHiddenDays(u)).clone(), this.opt("showNonCurrentDates") || (d = d.intersect(a.unzonedRange)), o = r.duration(this.opt("minTime")), s = r.duration(this.opt("maxTime")), (d = (d = this.adjustActiveRange(d, o, s)).intersect(i)) && (t = this.msToUtcMoment(d.constrainDate(t), p)), c = a.unzonedRange.intersectsWith(i), {
          validUnzonedRange: i,
        ...
        function h() {
          u = t.clone().startOf(p), d = u.clone().add(n), c = new o.default(u, d)
        }
        return p || ((a = this.opt("dateIncrement")) ? (l = r.duration(a), p = l < n ? i.computeDurationGreatestUnit(l, a) : s) : p = s), n.as("days") <= 1 && this._view.isHiddenDay(u) && (u = this._view.skipHiddenDays(u, e)).startOf("day"), h(), this.trimHiddenDays(c) || (t = this._view.skipHiddenDays(t, e), h()), c
    ...
    f = function(t) {
      ...
      return r.__extends(e, t), e.prototype.end = function() {
        ...
        (this.dragListener = new d.default(u, {
          ...
          hitOver: function(t) {
            ...
            i && (r = l.computeExternalDrop(i, h)) ? (e = new p.default(r.buildInstances()), n = h.eventProps ? u.isEventInstanceGroupAllowed(e) : u.isExternalInstanceGroupAllowed(e)) : n = !1, n || (r = null, a.disableCursor()), r && u.renderDrag(u.eventRangesToEventFootprints(e.sliceRenderRanges(u.dateProfile.renderUnzonedRange, c.calendar)))
          },
          hitOut: function() {
            r = null
          },
          ...
          interactionEnd: function(e) {
            r && c.reportExternalDrop(r, Boolean(h.eventProps), Boolean(h.stick), t, e, n), l.isDragging = !1, l.dragListener = null
          }
        })).startDrag(e)
      }, e.prototype.computeExternalDrop = function(t, e) {
        var n, r = this.view.calendar,
        o = l.default.utc(t.unzonedRange.startMs).stripZone();
        return t.isAllDay && (e.startTime ? o.time(e.startTime) : o.stripTime()), e.duration && (n = o.clone().add(e.duration)), o = r.applyTimezone(o), n && (n = r.applyTimezone(n)), c.default.parse(i.extend({}, e.eventProps, {
          start: o,
          end: n
        }), new h.default(r))
      }, e
    }(n(15).default);
    e.default = f, u.default.mixInto(f), s.dataAttrPrefix = ""
  }, function(t, e, n) {
    Object.defineProperty(e, "__esModule", {
      value: !0
    });
      ...
      return r.__extends(e, t), e.prototype.end = function() {
        ...
        return this.dragListener = new l.default(s, {
          ...
          hitOver: function(n, l, c) {
            ...
            g && v && (r = e ? i.computeEventStartResizeMutation(g, v, t.footprint) : i.computeEventEndResizeMutation(g, v, t.footprint)) ? (h = d.buildMutatedEventInstanceGroup(p.id, r), f = s.isEventInstanceGroupAllowed(h)) : f = !1, f ? r.isEmpty() && (r = null) : (r = null, o.disableCursor()), r && (a.hideEventsWithId(t.footprint.eventDef.id), a.renderEventResize(s.eventRangesToEventFootprints(h.sliceRenderRanges(s.dateProfile.renderUnzonedRange, u)), t))
          },
          hitOut: function() {
            r = null
          },
    ...
    e.default = h, h.prototype.timeGridClass = c.default, h.prototype.dayGridClass = p.default, r = {
      ...
      return r.__extends(e, t), e.prototype.renderFgSegs = function(t) {
        ...
        if (f.unshift("fc-time-grid-event", "fc-v-event"), s.isMultiDayRange(l.unzonedRange)) {
          if (t.isStart || t.isEnd) {
            ...
            n = this._getTimeText(v, y, u), r = this._getTimeText(v, y, u, "LT"), o = this._getTimeText(v, y, u, null, !1)
          }
    ...
    s = function(t) {
      ...
      return r.__extends(e, t), e.prototype.renderBgRanges = function(e) {
        ...
        function y(t) {
          for (; o < t;)(u = (v[n - 1] || [])[o]) ? u.attr("rowspan", parseInt(u.attr("rowspan") || 1, 10) + 1) : (u = i("<td/>"), s.append(u)), g[n][o] = u, v[n][o] = u, o++
        }
        for (n = 0; n < p; n++) {
          if (r = c[n], o = 0, s = i("<tr/>"), f.push([]), g.push([]), v.push([]), r)
          for (a = 0; a < r.length; a++) {
            for (y((l = r[a]).leftCol), u = i('<td class="fc-event-container"/>').append(l.el), l.leftCol !== l.rightCol ? u.attr("colspan", l.rightCol - l.leftCol + 1) : v[n][o] = u; o <= l.rightCol;) g[n][o] = u, f[n][o] = l, o++;
            s.append(u)
          }
          y(d), this.dayGrid.bookendCells(s), h.append(s)
        }
        return {
          row: t,
          tbodyEl: h,
        ...
        h = "";
        return c.unshift("fc-day-grid-event", "fc-h-event"), t.isStart && (n = this.getTimeText(t.footprint)) && (h = '<span class="fc-time">' + o.htmlEscape(n) + "</span>"), r = '<span class="fc-title">' + (o.htmlEscape(s.title || "") || "&nbsp;") + "</span>", '<a class="' + c.join(" ") + '"' + (s.url ? ' href="' + o.htmlEscape(s.url) + '"' : "") + (p ? ' style="' + p + '"' : "") + '><div class="fc-content">' + (this.dayGrid.isRTL ? r + " " + h : h + " " + r) + "</div>" + (u ? '<div class="fc-resizer fc-start-resizer" />' : "") + (d ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
      }, e
    }(n(42).default);
...
function(t, e) {
  ...
  return function(t) {
    ...
    266: function(t, e, n) {
      ...
      var r = n(1),
      i = n(267);
      r.EventSourceParser.registerClass(i.default), r.GcalEventSource = i.default
    },
    267: function(t, e, n) {
      Object.defineProperty(e, "__esModule", {
        value: !0
      ...
      s = function(t) {
        ...
        return r.__extends(e, t), e.parse = function(t, e) {
          ...
          return a ? (this.calendar.pushLoading(), o.Promise.construct(function(t, e) {
            i.ajax(i.extend({}, o.JsonFeedEventSource.AJAX_DEFAULTS, l, {
              url: s,
              data: a,
              success: function(n, s, l) {
                var d, c;
                r.calendar.popLoading(), n.error ? (r.reportError("Google Calendar API: " + n.error.message, n.error.errors), e()) : n.items && (d = r.gcalItemsToRawEventDefs(n.items, a.timeZone), c = o.applyAll(u, r, [n, s, l]), i.isArray(c) && (d = c), t(r.parseEventDefs(d)))
              },
              error: function(t, n, i) {
                r.reportError("Google Calendar network failure: " + n, [t, i]), r.calendar.popLoading(), e()
              }
            }))
          })) : o.Promise.reject()
          ...
          return n && e && (n = function(t, e) {
            return t.replace(/(\?.*?)?(#|$)/, function(t, n, r) {
              return (n ? n + "&" : "?") + e + r
            })
          }(n, "ctz=" + e)), {
            id: t.id,
          ...
          this.googleCalendarError && this.googleCalendarError.apply(n, i), r && r.apply(n, i), o.warn.apply(null, [t].concat(e || []))
        }, e.prototype.getPrimitive = function() {
          ...
          }(t.url)), null != n && (this.googleCalendarId = n, e)
        }, e.prototype.applyMiscProps = function(t) {
          this.ajaxSettings || (this.ajaxSettings = {}), i.extend(this.ajaxSettings, t)
        }, e.API_BASE = "https://www.googleapis.com/calendar/v3/calendars", e
      }(o.EventSource);
      e.default = s, s.defineStandardProps({
        url: !1,
        googleCalendarId: !1,
