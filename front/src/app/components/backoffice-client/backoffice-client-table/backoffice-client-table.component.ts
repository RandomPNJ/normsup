...
@Component({
  selector: 'app-backoffice-client-table',
  templateUrl: './backoffice-client-table.component.html',
  styleUrls: ['./backoffice-client-table.component.scss']
})
export class BackofficeClientTableComponent implements OnInit {
    ...
    ngOnInit() {
      ...
      this.dtOptions = {
        ...
        ajax: (dataTablesParameters: any, callback: any) => {
          ...
          if(action === 'query') {
            that.httpService
              .get('/api/admin/clients', that.tableParams)
              .subscribe(resp => {
