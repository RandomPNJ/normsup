...
@Component({
  selector: 'app-backoffice-client',
  templateUrl: './backoffice-client.component.html',
  styleUrls: ['./backoffice-client.component.scss']
})
export class BackofficeClientComponent implements OnInit {
